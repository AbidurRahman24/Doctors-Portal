...
import cavidyCheck from '../../../images/cavidyCheck.png'
const FeaturedService = () => {
    return (
        <section className='container pb-0 pb-md-5 my-5'>
            <div className="row mb-5">
                <div className="col-md-5  mb-4 m-md-0">
                    <img className="img-fluid" src={cavidyCheck} alt="" />
                </div>
                <div className="col-md-7 align-self-center p-4">
